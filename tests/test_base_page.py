...
class TestBasePageRun:
    ...
    def test_set_page_config_called_with_subtitle(self) -> None:
        ...
        page = _ConcretePage()
        with patch("app.base_page.st", _make_mock_st()) as mock_st, patch(
            "app.base_page.init_db"
        ):
            page.run()
    ...
    def test_init_db_called_with_db_path(self) -> None:
        ...
        page = _ConcretePage()
        with patch("app.base_page.st", _make_mock_st()), patch(
            "app.base_page.init_db"
        ) as mock_init_db:
            page.run()
    ...
    def test_body_is_called(self) -> None:
        ...
        page = _ConcretePage()
        with patch("app.base_page.st", _make_mock_st()), patch("app.base_page.init_db"):
            page.run()
    ...
    def test_exit_button_calls_os_exit(self) -> None:
        ...
        page = _ConcretePage()
        with patch("app.base_page.st", _make_mock_st(button_clicked=True)), patch(
            "app.base_page.init_db"
    ...
    def test_exit_button_not_called_when_not_clicked(self) -> None:
        ...
        page = _ConcretePage()
        with patch("app.base_page.st", _make_mock_st(button_clicked=False)), patch(
            "app.base_page.init_db"
        ), patch("app.base_page.os") as mock_os:
            page.run()
